...
h-[50vh] -z-10 bg-gradient-to-b from-cyan-100/70'></div>
...
<div className='max-w-xl z-10 text-gray-500'>
  <h1 className='md:text-font-semibold text-gray-800'>
...
<div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Nikhil</span></p>
